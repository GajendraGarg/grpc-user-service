...
type UserServiceClient interface {
	...
	SearchUser(ctx context.Context, in *SearchUserRequest, opts ...grpc.CallOption) (*UsersResponse, error)
}
...
func (c *userServiceClient) SearchUser(ctx context.Context, in *SearchUserRequest, opts ...grpc.CallOption) (*UsersResponse, error) {
	out := new(UsersResponse)
...
type UserServiceServer interface {
	...
	SearchUser(context.Context, *SearchUserRequest) (*UsersResponse, error)
...
func (UnimplementedUserServiceServer) SearchUser(context.Context, *SearchUserRequest) (*UsersResponse, error) {
